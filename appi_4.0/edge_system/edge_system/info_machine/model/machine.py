...
from wtforms import StringField, DateField, IntegerField, DecimalField, SelectField
...
class RegisterForm(FlaskForm):
    ...
    id_line = SelectField('Line id', validators = [InputRequired()])
    ...
    id_supplier = SelectField('Supplier id', validators = [InputRequired()])
